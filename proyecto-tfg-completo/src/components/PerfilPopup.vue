  ...
  methods: {
    async createPost() {
      if (this.file != null) {
        ...
        await axios.post("http://164.90.219.15:3001/api/localimages/perfil",perfilImg);
      }
      if (this.formularioEditar.user != "") {
        console.log(this.formularioEditar.user);
        await axios.post("http://164.90.219.15:3001/api/editarPerfil", this.formularioEditar)
      }
