...
export default {
  ...
  methods: {
    async createPost() {
      ...
      await axios.post('http://167.99.240.123:3001/api/localimages/productos', productos);
      ...
      await axios.post("http://167.99.240.123:3001/api", objeto)
      window.location.href = 'http://167.99.240.123:8080/'
