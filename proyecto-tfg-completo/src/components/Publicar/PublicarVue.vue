...
export default {
  ...
  methods: {
    async createPost() {
      ...
      await axios.post('http://164.90.219.15:3001/api/localimages/productos', productos);
      ...
      await axios.post("http://164.90.219.15:3001/api", objeto)
      window.location.href = 'http://164.90.219.15:8080/'
